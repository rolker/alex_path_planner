...
#include <alex_path_planner_common/StateMsg.h>
...
public:
     ...
     */
    alex_path_planner_common::StateMsg convertToStateMsg(const State& state);
     ...
     * @return
     */
    State convertToStateFromMsg(const alex_path_planner_common::StateMsg& stateMsg);
