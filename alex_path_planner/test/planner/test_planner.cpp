...
#include <thread>
#include <alex_path_planner_common/Plan.h>
...
static DubinsPlan getPlan(alex_path_planner_common::Plan plan) {
    DubinsPlan result;
...
static alex_path_planner_common::Plan getPlanMsg(const DubinsPlan& plan) {
