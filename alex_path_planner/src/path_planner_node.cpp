...
public:
    ...
    m_stats_pub = m_node_handle.advertise<alex_path_planner_common::Stats>("path_planner/stats", 1);
    m_task_level_stats_pub = m_node_handle.advertise<alex_path_planner_common::TaskLevelStats>("path_planner/task_level_stats", 1);

        dynamic_reconfigure::Server<alex_path_planner::alex_path_plannerConfig>::CallbackType f;
...
//        return;
        ...
        alex_path_planner::alex_path_plannerConfig config;
...
//        std::cerr << "Planner appears to have finished" << std::endl;
    ...
    void reconfigureCallback(alex_path_planner::alex_path_plannerConfig &config, uint32_t level) {
...
private:
    ...
    dynamic_reconfigure::Server<alex_path_planner::alex_path_plannerConfig> m_Dynamic_Reconfigure_Server;
